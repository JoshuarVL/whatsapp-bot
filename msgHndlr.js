...
module.exports = msgHandler = async (client, message) => {
    try {
        ...
        const ownerNumber = ["6281298045240@c.us",""] // replace with your whatsapp number
        ...
        case '!nulis':
            ...
            .then(res => res.json())
            .then(async (json) => {
                await client.sendFileFromUrl(from, json.result, 'Nulis.jpg', 'Nih Bro/Bu/Pak', id)
        ...
        case '!linkgroup':
            ...
            break
        case '!bc':
            client.reply(from, 'Maaf Perintah Diremoved Karena Berbahaya Bagi Yg punya BOT')
            break
        case '!adminlist':
            if (!isGroupMsg) return client.reply(from, 'Perintah ini hanya bisa di gunakan dalam group!', id)
            let mimin = ''
